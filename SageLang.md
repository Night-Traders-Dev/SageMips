...
> **Version:** 3.9.6 | **Spec Version:** 2.0 | **License:** MIT  
...
**Soft keywords** (v3.9.6+): `match`, `init`, `enum`, `struct`, `trait` — can be used as variable names in expressions and assignments.
